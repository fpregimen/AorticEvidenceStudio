...
import type { LegacyAlias, SpecialistDecision, VerificationStatus } from "./types.ts";
...
export interface LegacyCandidateItem {
  ...
  reviewerName: string; reviewDate: string; originalSourceConfirmed: boolean; verificationStatus: VerificationStatus;
